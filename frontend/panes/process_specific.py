...
from frontend.style import status_alert_class, apply_figure_theme, DROPDOWN_STYLE, COMPACT_DROPDOWN_STYLE, CARD_STYLE
                ...
                dbc.Col(
                    [
                        dbc.Card(
                            ...
                            style={"height": "100%", "marginBottom": "10px", **CARD_STYLE},
                        ),
                    ],
                    width=12,
                    lg=6,
